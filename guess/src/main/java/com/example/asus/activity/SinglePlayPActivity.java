...
public class SinglePlayPActivity extends MySwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_play_p);
    ...
    private RecognizerListener mRecognizerDialogListener = new RecognizerListener() {
        ...
        public void onEndOfSpeech() {
            ...
            if (str.equals(mMovieInfo.getMovieName())) {
                MyToast.getInstance().showBottomShortDone(SinglePlayPActivity.this, "");
                mRightNum++;
                    ...
                    if (list.size() > 0) {
                        ...
                        record.update(new UpdateListener() {
                            ...
                            public void done(BmobException e) {
                                if (e != null) {
                                    checkCommonException(e, SinglePlayPActivity.this);
                                }
                            }
                        });
                    } else {
    ...
    private boolean initNextMovie() {
        ...
        Glide.with(this).load(mMovieInfo.getImage().getUrl()).listener(new RequestListener<String, GlideDrawable>() {
            ...
            public boolean onResourceReady(GlideDrawable resource, String model, Target<GlideDrawable> target, boolean isFromMemoryCache, boolean isFirstResource) {
                try {
                    loge("onResourceReady width" + (((GlideBitmapDrawable) resource).getBitmap().getWidth()));
                    loge("onResourceReady height" + (((GlideBitmapDrawable) resource).getBitmap().getHeight()));
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!String.valueOf(mKeyChar.get(chooseKeyNum)).equals(textView.getText().toString())) {
                    MyToast.getInstance().showBottomShortWrong(SinglePlayPActivity.this, "");
                    jump(null);
                } else {
